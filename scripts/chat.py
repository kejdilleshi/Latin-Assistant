...
model_name = "results/Apertus_latin/checkpoint-600" 
...
messages_think = [
    {"role": "system", "content": """You are a helpful Latin translation assistant."""},
]
...
while True:
    try:
        ...
        output_ids = generated_ids[0][len(model_inputs.input_ids[0]):] # print only the generated part 
